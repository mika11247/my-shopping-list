...
/>
  ...
  >
    <div>
      <p className="text-sm font-bold text-neutral-700">表示モード</p>
      ...
      {mode === "group" && (
        <>
          <select
            ...
            className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm text-gray-800 outline-none"
          >
